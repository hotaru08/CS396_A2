...
namespace grid
{
    ...
    constexpr int   max_resolution_width_v = 1024;  // Max space width that the grids will be generated
    constexpr int   max_resolution_height_v = 800;  // Max 
    ...
    constexpr __inline bool Search(
    ...
    //---------------------------------------------------------------------------------------
    constexpr GridCell ComputeGridCellFromWorldPosition(const xcore::vector2 Position) noexcept
    {
